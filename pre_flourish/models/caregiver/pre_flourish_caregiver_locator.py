...
class PreFlourishLocatorManager(SearchSlugManager, models.Manager):

    def get_by_natural_key(self, subject_identifier):
        return self.get(subject_identifier=subject_identifier)


class PreFlourishCaregiverLocator(SiteModelMixin, SubjectContactFieldsMixin,
    ...
    action_name = PRE_FLOURISH_CAREGIVER_LOCATOR_ACTION
    ...
    objects = PreFlourishLocatorManager()

    class Meta:
        app_label = 'pre_flourish'
        verbose_name = 'Pre Flourish Caregiver Locator'

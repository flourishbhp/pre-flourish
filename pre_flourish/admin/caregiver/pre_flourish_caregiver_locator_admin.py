...
from ...forms import PreFlourishCaregiverLocatorForm
from ...models import PreFlourishCaregiverLocator
from .modeladmin_mixins import ModelAdminMixin


@admin.register(PreFlourishCaregiverLocator, site=pre_flourish_admin)
class PreFlourishCaregiverLocatorAdmin(ModelAdminMixin, admin.ModelAdmin):

    form = PreFlourishCaregiverLocatorForm

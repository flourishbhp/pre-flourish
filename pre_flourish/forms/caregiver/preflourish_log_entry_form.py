...
from ...choices import PHONE_SUCCESS, PHONE_USED
# from flourish_ import LogEntryFormValidator
...
class PreFlourishLogEntryForm(
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.fields['phone_num_type'].choices = (
        #     ('none_of_the_above', 'None of the above')
        # )
        # self.fields['phone_num_success'].choices = (
        #     ('none_of_the_above', 'None of the above'),
        # )
